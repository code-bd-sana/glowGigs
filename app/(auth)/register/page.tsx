...
export default function RegisterPage() {
  ...
  const commonFields = (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="text-left">
        <label htmlFor="phoneNumber" className="block font-medium text-gray-900 mb-2">
          Phone Number *
        </label>
        <input
          type="tel"
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="text-left">
          ...
          <select
            className="w-full border border-gray-300 rounded-lg px-4 py-3 text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-transparent"
            onChange={(e) => handleInputChange('employmentEligibility', e.target.value)}
          >
            <option value="">Select your employment eligibility</option>
            <option value="US_CITIZEN">US Citizen</option>
            <option value="PERMANENT_RESIDENT">Permanent Resident</option>
            <option value="AUTHORIZED_NONCITIZEN">Authorized Non-Citizen</option>
          </select>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center">
          <input
            ...
            className="w-4 h-4 text-black border-gray-300 rounded focus:ring-gray-400"
            onChange={(e) => handleCheckboxChange('isAuthorizedToWorkInUS', e.target.checked)}
          />
          <label htmlFor="isAuthorizedToWorkInUS" className="ml-2 text-gray-700">
        ...
        <div className="flex items-center">
          <input
            ...
            className="w-4 h-4 text-black border-gray-300 rounded focus:ring-gray-400"
            onChange={(e) => handleCheckboxChange('requiresVisaSponsorship', e.target.checked)}
          />
          <label htmlFor="requiresVisaSponsorship" className="ml-2 text-gray-700">
        ...
        <div className="flex items-center">
          <input
            ...
            required
            className="w-4 h-4 text-black border-gray-300 rounded focus:ring-gray-400"
            onChange={(e) => handleCheckboxChange('certificationAcknowledged', e.target.checked)}
          />
          <label htmlFor="certificationAcknowledged" className="ml-2 text-gray-700">
  ...
  const employerFields = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="text-left">
          <label htmlFor="companyName" className="block font-medium text-gray-900 mb-2">
            Company Name *
          </label>
          <input
            type="text"
        ...
        <div className="text-left">
          <label htmlFor="companySize" className="block font-medium text-gray-900 mb-2">
            Company Size *
          </label>
          <select
            id="companySize"
        ...
        <div className="text-left">
          <label htmlFor="companyWebsite" className="block font-medium text-gray-900 mb-2">
            Company Website
          </label>
          <input
            type="url"
        ...
        <div className="text-left">
          <label htmlFor="industry" className="block font-medium text-gray-900 mb-2">
            Industry
          </label>
          <input
            type="text"
      ...
      <div className="text-left">
        <label htmlFor="companyDescription" className="block font-medium text-gray-900 mb-2">
          Company Description
        </label>
        <textarea
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-gray-50 rounded-xl p-6">
            <h3 className="text-xl font-semibold text-gray-900 mb-6">
              {activeTab === 'JOB_SEEKER' ? 'Job Seeker Information' : 'Company Information'}
            </h3>
