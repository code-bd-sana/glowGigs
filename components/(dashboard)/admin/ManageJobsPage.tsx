  ...
  return (
    <div>
      ...
      <div className='space-y-3'>
        <h6 className="text-lg font-semibold text-gray-800">Job Management</h6>
        <p className="text-sm text-gray-500">Manage and monitor all job postings across the platform</p>
      </div>
